...
- **App only**
    ...
    ```bash
    $ kubectl apply -f https://raw.githubusercontent.com/kyverno/kyverno-http-authorizer/main/tests/performance-test/manifest/app.yaml
    ```
...
- **App and Envoy**
    ...
    ```bash
    $ kubectl apply -f https://raw.githubusercontent.com/kyverno/kyverno-http-authorizer/main/tests/performance-test/manifest/app-envoy.yaml
    ```
...
- **App, Envoy and Kyverno Authz Server**
    ...
    ```bash
    $ kubectl apply -f https://raw.githubusercontent.com/kyverno/kyverno-http-authorizer/main/tests/performance-test/manifest/app-envoy-plugin.yaml
    ```
